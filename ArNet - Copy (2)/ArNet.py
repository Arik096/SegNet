...
def arnet(img_size,classes,optimizer,loss_function,metric):
    ...
    conv8 = Conv2D(kernel_size=(3,3),filters=256,padding='same',kernel_initializer='he_normal',kernel_regularizer=l2(0.0001))(conv7)
    conv8 = Dropout(0.5)(conv8)
    conv8 = BatchNormalization()(conv8)
    conv8 = Activation('relu')(conv8)    
        
    conv9 = Conv2D(kernel_size=(3,3),filters=256,padding='same',kernel_initializer='he_normal',kernel_regularizer=l2(0.0001))(conv8)
    ...
    conv10 = Conv2D(kernel_size=(3,3),filters=128,padding='same',kernel_initializer='he_normal',kernel_regularizer=l2(0.0001))(up4)
    conv10 = Dropout(0.5)(conv10)
    conv10 = BatchNormalization()(conv10)
    conv10 = Activation('relu')(conv10)    
         
    conv11 = Conv2D(kernel_size=(3,3),filters=128,padding='same',kernel_initializer='he_normal',kernel_regularizer=l2(0.0001))(conv10)
    conv11 = BatchNormalization()(conv11)
    conv11 = Activation('relu')(conv11)   
                            
    up5 = UpSampling2D(size=(2,2))(conv11)  
                
    conv12 = Conv2D(kernel_size=(3,3),filters=64,padding='same',kernel_initializer='he_normal',kernel_regularizer=l2(0.0001))(up5)
    conv12 = Dropout(0.5)(conv12)
    conv12 = BatchNormalization()(conv12)
    conv12 = Activation('relu')(conv12)  
          
    conv13 = Conv2D(kernel_size=(3,3),filters=64,padding='same',kernel_initializer='he_normal',kernel_regularizer=l2(0.0001))(conv12)
